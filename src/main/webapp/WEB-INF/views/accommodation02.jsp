	...
	<main>
		<div class="container">
			<ul class="accomm-tab-bar">
				<li class="active"><a href="javascript:;">스탠다드더블</a></li>
			...
			<div class="swiper gallary-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="/img/accommodation02_01.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation02_02.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation02_03.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation02_04.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation02_05.jpg" />
					</div>
				</div>
			...
			<article class="detail-box">
				<h2>스탠다드더블<span>Standard Double</span></h2>
				...
				<div class="detail-info">
					...
					<ul>
						...
						<li>
							<h4>객실구성</h4>
							<span>침실 1개(침대크기 : 1,500 x 2,000mm 1개), 욕실 1개</span>
						</li>
						<li>
							<h4>난방방식</h4>
