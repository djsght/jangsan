...
<script type="text/javascript">
	...
	function reserve15(){
		var url = 'https://booking.naver.com/booking/3/bizes/1657882/items/7696797?area=pll';
	...
	<main>
		<div class="container">
			<ul class="accomm-tab-bar">
				...
				<li class="active"><a href="javascript:;">15호실</a></li>
			...
			<div class="swiper gallary-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="<c:url value='/img/webp/accomm_ex_15.webp'/>" alt="15호실_전경">
					</div>
					<div class="swiper-slide">
			...
			<article class="detail-box">
				...
				<div class="detail-info">
					...
					<ul>
						...
						<li>
							<h4>객실구성</h4>
							<span>원룸형(더블 1개), 주방 1개, 욕실 1개</span>
						</li>
						<li>
							<h4>예약 및 문의안내</h4>
			...
			<article class="accom-map">
				...
				<img src="<c:url value='/img/webp/map_b.webp'/>" alt="typeB 배치도">
			</article>
		</div>
	</main>
</body>
