	...
	<main>
		<div class="container">
			<div class="swiper gallary-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="/img/facilities04_01.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/facilities04_02.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/facilities04_03.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/facilities04_04.jpg" />
					</div>
				</div>
			...
			<article class="detail-box etc">
				<h2>소연회장<span>Small Banquet Hall</span></h2>
				<p>소규모 비즈니스 및 프라이빗 미팅을 진행 할 수 있으며, 세미나와 미팅에 필요한 다양한 시설과 서비스를합니다.</p>
				<div class="detail-info">
					...
					<ul>
						...
						<li>마이크, 음향시설</li>
						<li>무선 프리젠터</li>
						<li>98인치 Digital Signage(Digital Information Display) </li>
					</ul>
