			...
			<div class="swiper gallary-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="<c:url value='/img/webp/accomm_4_1.webp'/>" alt="상품 이미지">
					</div>
					<div class="swiper-slide">
						<img src="<c:url value='/img/webp/accomm_4_2.webp'/>" alt="상품 이미지">
					</div>
					<div class="swiper-slide">
						<img src="<c:url value='/img/webp/accomm_4_3.webp'/>" alt="상품 이미지">
					</div>
					<div class="swiper-slide">
						<img src="<c:url value='/img/webp/accomm_4_4.webp'/>" alt="상품 이미지">
					</div>
				</div>
