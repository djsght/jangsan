...
<script type="text/javascript">
	...
	function reserve14(){
		var url = 'https://booking.naver.com/booking/3/bizes/1657882/items/7696796?area=pll';
	...
	<main>
		<div class="container">
			<ul class="accomm-tab-bar">
				...
				<li class="active"><a href="javascript:;">14호실</a></li>
			</ul>
			<div class="swiper gallary-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="<c:url value='/img/webp/accomm_ex_14.webp'/>" alt="14호실_전경">
					</div>
					<div class="swiper-slide">
			...
			<article class="detail-box">
				...
				<div class="detail-info">
					...
					<ul>
						...
						<li>
							<h4>객실구성</h4>
							<span>침실 2개(더블 1개, 온돌 1개), 거실 2개, 주방 1개, 욕실 2개</span>
						</li>
						<li>
							<h4>예약 및 문의안내</h4>
			...
			<article class="accom-map">
				...
				<img src="<c:url value='/img/webp/map_g.webp'/>" alt="typeG 배치도">
			</article>
		</div>
	</main>
</body>
