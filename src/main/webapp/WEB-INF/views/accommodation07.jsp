	...
	<main>
		<div class="container">
			<ul class="accomm-tab-bar">
				...
				<li class="active"><a href="javascript:;">로얄패밀리</a></li>
			</ul>
			<div class="swiper gallary-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="/img/accommodation07_01.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation07_02.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation07_03.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation07_04.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation07_05.jpg" />
					</div>
				</div>
			...
			<article class="detail-box">
				<h2>로얄패밀리<span>Royal Family</span></h2>
