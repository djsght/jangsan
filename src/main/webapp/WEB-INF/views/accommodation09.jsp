	...
	<main>
		<div class="container">
			<ul class="accomm-tab-bar">
				...
				<li class="active"><a href="javascript:;">프리미엄스위트</a></li>
				<li><a href="/accommodation10">프리미엄패밀리</a></li>
			</ul>
			<div class="swiper gallary-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="/img/accommodation09_01.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation09_02.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation09_03.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation09_04.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation09_05.jpg" />
					</div>
					<div class="swiper-slide">
						<img src="/img/accommodation09_06.jpg" />
					</div>
				</div>
			...
			<article class="detail-box">
				<h2>프리미엄스위트<span>Premium Suite</span></h2>
				<p>유럽풍의 엔틱 가구로 된 넓은 공간에서 부부, 연인들이 행복한 시간을 가질 수 있으며 두 개의 침실로 되어 있어 추가 숙박이 가능합니다.</p>
